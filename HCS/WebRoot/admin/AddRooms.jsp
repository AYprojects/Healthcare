...
<div id="conteiner"><div id="header"><div class="menu">
  ...
  <h1>AddRooms !</h1>
      <form action="./RoomController.jsp" method="post">
  ...
  <tr>
    ...
    <%
            ...
            Session s=sf.openSession();
             Query q=s.createQuery("from Rooms");
             List list=q.list();
             Iterator it=list.iterator();
             while(it.hasNext()){
             Rooms reg=(Rooms)it.next();

             %>
             <option value="<%= reg.getRid() %>"><%= reg.getRoomname() %></option>
             <%} %>
    </select></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center" colspan="2"> <input name=""  type="submit" value="AddRoom"></td>
      </tr>
</table>
</form>
  </div>
