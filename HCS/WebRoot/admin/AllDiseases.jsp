...
<legend><h3>Hospitals</h3></legend>
 ...
 <tr align="center"><th>DiseaseName</th><th>DiseasesDiscription</th><th>DiseaseId</th></tr>
 <%SessionFactory sf=(SessionFactory)getServletContext().getAttribute("sf");
Session s=sf.openSession();
Query q=s.createQuery("from Diseases");
Iterator it=q.iterate();
 while(it.hasNext()){
 Diseases h=(Diseases)it.next();

 %>
 <tr align="center"><th><%= h.getDname() %></th><th><%= h.getDescr() %></th><th><%= h.getDid() %></th></tr>
 <%} %></table>
 </fieldset>
  </div>
