...
<%@page import="beans.Patientstatus"%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"><html>
<html>
<head>
...
<div id="conteiner"><div id="header"><div class="menu">
  ...
  <fieldset>
  <legend><h1>Patient Status</h1></legend>
 <table width="600" height="100" align="center" border="1">
  ...
  Query q1= s.createQuery("From Patientstatus where patient=:user ");
...
System.out.println(pa);
  ...
  Iterator it2=q1.iterate();
     while(it2.hasNext()){
    Patientstatus pod=(Patientstatus)it2.next();
     %>
  <tr align="center" bgcolor="pink">
    <td><%= pod.getPatient().getPname() %></td>
    <td><%= pod.getDoctors().getUsername() %></td>
    <td><%= pod.getCondition() %></td>
    <td><%= pod.getStatus() %></td>
  </tr>
<%} %>
</table>
