...
<div id="conteiner"><div id="header"><div class="menu">
  <ul>
    ...
    <li><a href="PrePatientAppointment.jsp">AddPatientStatus</a></li>
     <li><a href="AllInPatient.jsp">AllInPatient</a></li>
    <li><a href="OutPatient.jsp">OutPatient</a></li>
     <li><a href="AllDiseases.jsp">AllDiseases</a></li>
    <li><a href="AllDoctors.jsp">AllDoctors</a></li>
    <li><a href="AllHospitals.jsp">AllHospitals</a></li>
